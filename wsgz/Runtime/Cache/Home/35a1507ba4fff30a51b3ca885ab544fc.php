        ...
        <div class="main">
          <div class="main-h" >
            <ul class="breadcrumb">
              ...
              <li>
                <a href=<?php echo U('Personal/articlelist');?>>增改治水新闻</a>
                <span class="divider"></span>
              </li>
            ...
            <form class="frm-type">
              <a href=<?php echo U('Personal/articleadd');?>>
                <input type="button" class="btn btn-default" value="+添加新闻"></a>
              <ul class="list-group">
                <?php if(is_array($list)): foreach($list as $key=>$obj): ?><li class="list-group-item">
                    <a href=<?php echo U('Personal/articleres',array('id'=> $obj['message_id']));?> style="color:#663333">
                              <?php echo ($obj["message_time"]); ?>【<?php echo ($obj["message_author"]); ?>】<?php echo ($obj["message_title"]); ?>
                      <a  onClick="return confirm('确认要删除该条新闻？')" href=<?php echo U('Personal/articledel',array('id'=> $obj['message_id']));?> title="删除新闻" data-toggle="tooltip" >
                        <span class="glyphicon glyphicon-trash" style=" float:right;"></span>
                      </a>
                      <a href=<?php echo U('Personal/articleres',array('id'=> $obj['message_id']));?> title="修改新闻">
                        <span class="glyphicon glyphicon-pencil" style=" float:right;  margin-right:10px;"></span>
                      </a>
                    </a>
                  </li><?php endforeach; endif; ?>
                <div style="font-size:22px;"><?php echo ($nowp); ?></div>
              </ul>
