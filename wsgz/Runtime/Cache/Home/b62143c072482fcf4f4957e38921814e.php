          ...
          <div class="main">
              <div class="main-h" >
                <ul class="breadcrumb">
                  ...
                  <li>
                    <a href=<?php echo U('Personal/waterprovince');?>>治水文件上传</a> <span class="divider"></span>
                  </li>
                  <li class="active">
                    修改文件信息
                  </li>
                ...
                <form action=<?php echo U('Personal/documentres_fun');?> class="frm-type"  method="post">
                  <input style="display:none;" value=<?php echo ($nowart["documents_id"]); ?> name="id"/>  
                  <p>文件名字：
                    <input type="text" name="name" value="<?php echo ($nowart["documents_title"]); ?>"/>
                  </p>
                  <script type="text/plain" id="container" name="text" style="width:100%;height:300px;"> 
                    <?php echo ($nowart["documents_content"]); ?> 
                  </script>
                  </br>
