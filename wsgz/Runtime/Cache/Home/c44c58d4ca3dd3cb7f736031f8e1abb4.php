        ...
        <div class="main">
          <div class="main-h" >
            <ul class="breadcrumb">
              ...
              <li>
                <a href=<?php echo U('Personal/waterroad');?>>河道信息管理</a>
                <span class="divider"></span>
              </li>
              <li class="active">增加河道信息</li>
            </ul>
            <h3 class="side-lined" style="color:#000"><?php echo ($username); ?>欢迎你！</h3>
            <form action=<?php echo U('Personal/roadadd_fun');?> method="post">
              <input name="roadname" type="text" placeholder="请输入河道名字" class="form-control" style="width:50%">
              <br>
