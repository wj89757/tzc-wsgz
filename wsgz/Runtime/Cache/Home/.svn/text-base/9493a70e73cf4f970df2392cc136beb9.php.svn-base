      ...
      <div class="col-md-9 col-sm-8 col-lg-9 col-xs-8">
        <div class="main">
          <div class="main-h" >
            ...
            <form class="frm-type">
              <a href=<?php echo U('Personal/provinceadd');?>>
              ...
              <ul class="list-group">
                <?php if(is_array($list)): foreach($list as $key=>$obj): ?><li class="list-group-item">
                    <a href=<?php echo U('Personal/provinceres',array('id'=> $obj['provinces_id']));?> style="color:#663333">
                              <?php echo ($obj["provinces_time"]); ?>【<?php echo ($obj["provinces_title"]); ?>】
                      <a  onClick="return confirm('确认要删除该条省市简报？')" href=<?php echo U('Personal/provincedel',array('id'=> $obj['provinces_id']));?> title="删除省市简报" data-toggle="tooltip" >
                        <span class="glyphicon glyphicon-trash" style=" float:right;"></span>
                      </a>
                      <a href=<?php echo U('Personal/provinceres',array('id'=> $obj['provinces_id']));?> title="修改省市简报">
