        ...
        <div class="main">
          <div class="main-h" >
            <ul class="breadcrumb">
              ...
              <li class="active">添加省市简报</li>
            </ul>
            <h3 class="side-lined" style="color:#000"><?php echo ($username); ?>欢迎你！</h3>
            <form action=<?php echo U('Personal/provinceadd_fun');?> method="post">
              <input name="provincename" type="text" placeholder="请输入省市简报标题" class="form-control" style="width:50%">
              <br>
