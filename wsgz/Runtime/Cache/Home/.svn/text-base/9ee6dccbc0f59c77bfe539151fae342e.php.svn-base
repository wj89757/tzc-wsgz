        ...
        <div class="main">
          <div class="main-h" >
            <ul class="breadcrumb">
              ...
              <li>
                <a href=<?php echo U('Personal/noticelist');?>>投诉信息管理</a>
                <span class="divider"></span>
              </li>
            ...
            <div class="container-fluid">
              <div class="row">
                ...
                <?php if(is_array($hitlist)): foreach($hitlist as $key=>$item): ?><div class="col-lg-2 col-md-3 col-sm-4 col-xs-6" style="padding-left: 5px;padding-right: 5px;">
                    <div class="thumbnail">
                      <img src=<?php echo ($item["complian_imag"]); ?>>
                      <div class="caption">
                        <h4>
                          <a class="btn btn-default btn-small" href=<?php echo U('Personal/passnotice',array('id'=>$item['complian_id']));?>>通过投诉</a>
                        </h4>
                        <p><?php echo ($item["complian_title"]); ?></p>
                      </div>
                    </div>
