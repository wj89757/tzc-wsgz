          ...
          <div class="main">
              <div class="main-h" >
                <ul class="breadcrumb">
                  ...
                  <li>
                    <a href=<?php echo U('Personal/waterroad');?>>河道信息管理</a> <span class="divider"></span>
                  </li>
                  <li class="active">
                    修改河道信息
                  </li>
                ...
                <form action=<?php echo U('Personal/roadres_fun');?> class="frm-type"  method="post">
                  <input style="display:none;" value=<?php echo ($nowart["water_id"]); ?> name="id"/>  
                  <p>河道姓名：
                    <input type="text" name="name" value="<?php echo ($nowart["water_name"]); ?>"/>
                  </p>
                  <script type="text/plain" id="container" name="text" style="width:100%;height:300px;"> 
                    <?php echo ($nowart["water_introduction"]); ?> 
                  </script>
                  </br>
