...
<body>
  ...
  <!--自创sideba-->
    ...
    <ul class="list-group">
        ...
        <li class="list-group-item itemfix" id="upload"><a href="#"><span class="glyphicon glyphicon-list-alt"></span>&nbsp;政策文件上传</a></li>
       <li class="list-group-item itemfix" id="province" style="display: none"><a href=<?php echo U('Personal/pwdfix');?> style="color:#99cccc"><span class="glyphicon glyphicon-grain"></span>&nbsp;省市简报上传</a></li>
        ...
        <div class="col-md-9 col-sm-8 col-lg-9 col-xs-8">
          <div class="main">
              <div class="main-h" >
                ...
                <form action=<?php echo U('Personal/projectres_fun');?> class="frm-type"  method="post">
                  <input style="display:none;" value=<?php echo ($nowart["project_id"]); ?> name="id"/>  
                  <p>周志标题：
                    <input type="text" name="name" value="<?php echo ($nowart["project_name"]); ?>"/>
                  </p>
                  <script type="text/plain" id="container" name="text" style="width:100%;height:300px;"> 
                    <?php echo ($nowart["project_content"]); ?> 
                  </script>
                  </br>
