        ...
        <div class="main">
          <div class="main-h" >
            <ul class="breadcrumb">
              ...
              <li class="active">修改简报信息</li>
            </ul>
            <h3 class="side-lined" style="color:#000"><?php echo ($username); ?>欢迎你！</h3>
            <form action=<?php echo U('Personal/provinceres_fun');?> class="frm-type"  method="post">
              <input style="display:none;" value=<?php echo ($nowart["provinces_id"]); ?> name="id"/>
              <p>
                简报名字：
                <input type="text" name="name" value="<?php echo ($nowart["provinces_title"]); ?>"/>
              </p>
              <script type="text/plain" id="container" name="text" style="width:100%;height:300px;"><?php echo ($nowart["provinces_content"]); ?> </script>
            </br>
