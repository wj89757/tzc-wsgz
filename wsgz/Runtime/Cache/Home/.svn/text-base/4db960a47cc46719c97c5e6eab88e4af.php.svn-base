        ...
        <div class="main">
          <div class="main-h" >
            <ul class="breadcrumb">
              ...
              <li>
                <a href=<?php echo U('Personal/articlelist');?>>增改电商周志</a>
                <span class="divider"></span>
              </li>
              <li class="active">修改周志</li>
            </ul>
            <h3 class="side-lined" style="color:#000"><?php echo ($username); ?>欢迎你！</h3>
            <form action=<?php echo U('Personal/articleres_fun');?> class="frm-type"  method="post">
              <input style="display:none;" value=<?php echo ($nowart["message_id"]); ?> name="id"/>
              <p>
                周志标题：
                <input type="text" name="name" value="<?php echo ($nowart["message_title"]); ?>"/>
              </p>
              <p>
                周志概要：
                <textarea style="height:60px;width:400px;" name="overview" ><?php echo ($nowart["message_overview"]); ?></textarea>
              </p>
              <script type="text/plain" id="container" name="text" style="width:100%;height:300px;"><?php echo ($nowart["message_content"]); ?> </script>
            </br>
