...
<head>
  ...
  <script type="text/javascript" src="/wsgz/Public/js/password.js"></script>
</head>
<body>
  <!-- 头部文件开始 -->
  <!-- 响应式导航条 -->
        ...
        <div class="main">
          <div class="main-h" >
            <ul class="breadcrumb">
              ...
              <li>
                <a href=<?php echo U('Personal/noticelist');?>>修改密码</a>
                <span class="divider"></span>
              </li>
              <li class="active">主页</li>
            </ul>
            <h3 class="side-lined" style="color:#000"><?php echo ($username); ?>欢迎你！</h3>
            <form action=<?php echo U('Personal/changepwd');?> class="frm-type"  method="post">
              <input style="display:none;" value=<?php echo ($findid); ?> name="id"/>
              <p>
                用户名:
                <input class="form-control" type="text" name="name" value="<?php echo ($findname); ?>" disabled/>
              </p>
              <p>
                密码
                <input class="form-control" id="password" type="password" name="pwd" value="<?php echo ($findpassword); ?>"/>
              </p>
              <br>
