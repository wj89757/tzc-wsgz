          ...
          <div class="main">
              <div class="main-h" >
                <ul class="breadcrumb">
                  ...
                  <li>
                    <a href=<?php echo U('Personal/watercompany');?>>节水企业发布</a> <span class="divider"></span>
                  </li>
                  <li class="active">
                    添加节水企业信息
                  </li>
                ...
                <form action=<?php echo U('Personal/companyadd_fun');?> method="post">
                  <input name="companyname" type="text" placeholder="请输入节水企业名字" class="form-control" style="width:50%"><br>
                  <script type="text/plain" id="container" name="container" style="width:100%;height:300px;">  
                  </script>
                  <br>
