        ...
        <div class="main">
          <div class="main-h" >
            <ul class="breadcrumb">
              ...
              <li>
                <a href=<?php echo U('Personal/watercompany');?>>节水企业增加</a>
                <span class="divider"></span>
              </li>
              <li class="active">修改节水企业信息</li>
            </ul>
            <h3 class="side-lined" style="color:#000"><?php echo ($username); ?>欢迎你！</h3>
            <form action=<?php echo U('Personal/companyres_fun');?> class="frm-type"  method="post">
              <input style="display:none;" value=<?php echo ($nowart["saving_id"]); ?> name="id"/>
              <p>
                节水企业名字：
                <input type="text" name="name" value="<?php echo ($nowart["saving_name"]); ?>"/>
              </p>
              <script type="text/plain" id="container" name="text" style="width:100%;height:300px;"><?php echo ($nowart["saving_content"]); ?> </script>
            </br>
