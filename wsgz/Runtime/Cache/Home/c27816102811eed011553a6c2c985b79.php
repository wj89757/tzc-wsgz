        ...
        <div class="main">
          <div class="main-h" >
            <ul class="breadcrumb">
              ...
              <li class="active">节水企业增加</li>
            </ul>
            <h3 class="side-lined" style="color:#000"><?php echo ($username); ?>欢迎你！</h3>
            <form class="frm-type">
              <a href=<?php echo U('Personal/companyadd');?>>
                <input type="button" class="btn btn-default" value="+添加节水企业"></a>
              <ul class="list-group">
                <?php if(is_array($list)): foreach($list as $key=>$obj): ?><li class="list-group-item">
                    <a href=<?php echo U('Personal/companyres',array('id'=> $obj['saving_id']));?> style="color:#663333">
                              <?php echo ($obj["saving_time"]); ?>【<?php echo ($obj["saving_name"]); ?>】
                      <a  onClick="return confirm('确认要删除该条节水企业？')" href=<?php echo U('Personal/companydel',array('id'=> $obj['saving_id']));?> title="删除节水企业" data-toggle="tooltip" >
                        <span class="glyphicon glyphicon-trash" style=" float:right;"></span>
                      </a>
                      <a href=<?php echo U('Personal/companyres',array('id'=> $obj['saving_id']));?> title="修改节水企业">
