          ...
          <div class="main">
              <div class="main-h" >
                <ul class="breadcrumb">
                  ...
                  <li>
                    <a href=<?php echo U('Personal/waterproject');?>>治水项目发布</a> <span class="divider"></span>
                  </li>
                  <li class="active">
                    添加新治水项目
                  </li>
                ...
                <form action=<?php echo U('Personal/projectadd_fun');?> method="post">
                  <input name="projectname" type="text" placeholder="请输入治水项目标题" class="form-control" style="width:50%"><br>
