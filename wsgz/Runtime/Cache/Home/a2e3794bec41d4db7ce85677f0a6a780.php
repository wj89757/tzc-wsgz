        ...
        <div class="main">
          <div class="main-h" >
            <ul class="breadcrumb">
              ...
              <li class="active">添加新资讯</li>
            </ul>
            <h3 class="side-lined" style="color:#000"><?php echo ($username); ?>欢迎你！</h3>
            <form action=<?php echo U('Personal/articleadd_fun');?> method="post">
              <input name="taskname" type="text" placeholder="请输入新闻标题" class="form-control" style="width:50%">
              <br>

              <input name="taskauthor" type="text" placeholder="请输入作者姓名/昵称" class="form-control" style="width:50%">
              <br>
              <textarea style="height:35px;width:400px;" name="overview" placeholder="请输入新闻概要"></textarea>
              <br>
              <br>
