...
<body>
  ...
  <!--自创sideba-->
    ...
    <ul class="list-group">
        <li class="list-group-item itemfix"><a href=<?php echo U('Personal/noticelist');?>><span class="glyphicon glyphicon-phone-alt"></span>&nbsp;投诉信息管理</a></li>
        <li class="list-group-item itemfix"><a href=<?php echo U('Personal/articlelist');?>><span class="glyphicon glyphicon-edit"></span>&nbsp;增改治水新闻</a></li>

        <li class="list-group-item itemfix" id="infocol"><a href="#"}><span class="glyphicon glyphicon-comment"></span>&nbsp;信息会展管理</a></li>
        <li class="list-group-item itemfix" id="reproject" style="display: none"><a href=<?php echo U('Personal/waterproject');?> style="color:#99cccc"><span class="glyphicon glyphicon-th-list"></span>&nbsp;治水项目发布</a></li>
        <li class="list-group-item itemfix" id="savecom" style="display: none"><a href=<?php echo U('Personal/watercompany');?> style="color:#99cccc"><span class="glyphicon glyphicon-tint"></span>&nbsp;节水企业增加</a></li>
        <li class="list-group-item itemfix" id="rivercol" style="display: none"><a href=<?php echo U('Personal/waterroad');?> style="color:#99cccc"><span class="glyphicon glyphicon-grain"></span>&nbsp;河道信息管理</a></li>

        <li class="list-group-item itemfix" id="upload"><a href="#"><span class="glyphicon glyphicon-list-alt"></span>&nbsp;治水文件上传</a></li>
       <li class="list-group-item itemfix" id="province" style="display: none"><a href=<?php echo U('Personal/waterprovince');?> style="color:#99cccc"><span class="glyphicon glyphicon-grain"></span>&nbsp;省市简报上传</a></li>
       <li class="list-group-item itemfix" id="waterdocument" style="display: none"><a href=<?php echo U('Personal/waterdocument');?> style="color:#99cccc"><span class="glyphicon glyphicon-grain"></span>&nbsp;政策文件上传</a></li>
          ...
          <div class="main">
              <div class="main-h" >
                <ul class="breadcrumb">
                  ...
                  <li>
                    <a href="#">信息会展管理</a> <span class="divider"></span>
                  </li>
                  <li class="active">
                    治水项目发布
                  </li>
                ...
                <h3 class="side-lined" style="color:#000"><?php echo ($username); ?>欢迎你！</h3>
                  <form class="frm-type">     
                    <a href=<?php echo U('Personal/projectadd');?>>
                      <input type="button" class="btn btn-default" value="+添加治水项目">
                    </a>
                    <ul class="list-group">
                      <?php if(is_array($list)): foreach($list as $key=>$obj): ?><li class="list-group-item">
                          <a href=<?php echo U('Personal/projectres',array('id'=>$obj['project_id']));?> style="color:#663333">
                              <?php echo ($obj["project_time"]); ?>【<?php echo ($obj["project_name"]); ?>】
                          <a  onClick="return confirm('确认要删除该条治水项目？')" href=<?php echo U('Personal/projectdel',array('id'=>$obj['project_id']));?> title="删除治水项目" data-toggle="tooltip" ><span class="glyphicon glyphicon-trash" style=" float:right;"></span></a>
                          <a href=<?php echo U('Personal/projectres',array('id'=>$obj['project_id']));?> title="修改治水项目"><span class="glyphicon glyphicon-pencil" style=" float:right;  margin-right:10px;"></span></a>
                          </a>
